...
\begin{figure}
  ...
  \caption{Experimental setup, consisting of an iCub humanoid robot and a human user performing manipulation tasks on a shared table with different objects on top. A depth sensor~(top-left corner) is used to extract human hand coordinates for gesture recognition. TODO - show a human gesture that the reader can interpret easily}
