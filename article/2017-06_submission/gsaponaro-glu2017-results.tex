...
Fig.~TODO shows the resulting word occurrence probabilities of the two cases, respectively in blue and in red. We can interpret the difference in the predictions as follows:
\begin{itemize}
